"""Vectorized technical indicators used by the gold trading strategy."""
...
def rsi(series: pd.Series, period: int = 14) -> pd.Series:
    ...
    result = 100 - (100 / (1 + rs))
    # avg_loss == 0 means pure upward movement -> RSI should be 100, not the
    # 50 that fillna would otherwise produce for that case.
